var app = ( function() {
	...
	function initModels() {
		// fillstyle
		var fs = "fill";
		createModel("plane", "fillwireframe", [1, 1, 1, 1], [0, -.8, 0], [0, 0, 0], [1, 1, 1]);

		createModel("sphere", fs, [1,1,1,1], [-3,0.2,-2],[0,0,0],[.5,.5,.5]);
		createModel("cone", fs, [1, 1, 1, 1], [-3, 0, -2], [1.5, 0, 0], [0.5, 0.5, 1]);

		createModel("torus", fs, [1, 1, 1, 1], [2, 0, -.5], [1.6, 0, 0], [1, 1, 1]);
		createModel("torus", fs, [1, 1, 1, 1], [2, 0.8, -.5], [1.2, 0.5, 0], [0.8, 0.8, 0.8]);
		createModel("torus", fs, [1, 1, 1, 1], [2, 1.4, -.5], [1.1, 0, 0], [0.8, 0.8, 0.8]);
		createModel("sphere", fs, [1,1,1,1], [2,2,0],[0,0,0],[.1,.1,.1]);
		createModel("sphere", fs, [1,1,1,1], [2,2,-.5],[0,0,0],[.1,.1,.1]);
		createModel("sphere", fs, [1,1,1,1], [1,1.8,0.5],[0,0,0],[.1,.1,.1]);
		createModel("sphere", fs, [1, 1, 1, 1], [2, 0.5, -.5], [0, 0, 0], [.2, 1.6, .2]);

		createModel("sphere", fs, [1, 1, 1, 1], [0, 0.5, .5],[0,0,0],[.7,.7,.7]);
		createModel("cone", fs, [1, 1, 1, 1], [0, 0, .5], [1.5, 0, 0], [1, 1, 1]);

		createModel("fish", fs, [1, 1, 1, 1], [-2, 0, -.2], [0, .5, 0], [1, 1, 1]);
		createModel("fish", fs, [1, 1, 1, 1], [1.7, 0, -2], [0, 4, 0], [1, 1, 1]);
